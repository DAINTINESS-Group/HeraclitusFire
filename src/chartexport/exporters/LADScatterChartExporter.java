...
public class LADScatterChartExporter extends AbstractScatterChartExporter<String> {
	...
	public LADScatterChartExporter(String pOutputPath, String pTitle, HashMap<Integer, ArrayList<IElement>> pTuplesPerLADCollection, 
	...
	public void start(Stage primaryStage) throws Exception {
		...
		for(XYChart.Series<Number,String> nextSeries: this.allSeries)
